    ...
    static func centeredFullSize(forView: NSView, inView: NSView)  -> [NSLayoutConstraint] {
        ...
        let heightContraints = NSLayoutConstraint(item: forView, attribute:
            .height, relatedBy: .equal, toItem: inView,
                     attribute: NSLayoutConstraint.Attribute.height, multiplier: 1,
                     constant: 0)
        
        //width
        let widthContraints = NSLayoutConstraint(item: forView, attribute:
            .width, relatedBy: .equal, toItem: inView,
                    attribute: NSLayoutConstraint.Attribute.width, multiplier: 1.0,
                    constant: 0)
        
        //centerY - center Vertically
        
        let centerY = NSLayoutConstraint(item: forView, attribute: NSLayoutConstraint.Attribute.centerY, relatedBy: NSLayoutConstraint.Relation.equal, toItem: inView, attribute: NSLayoutConstraint.Attribute.centerY, multiplier: 1, constant: 0)
